...
items: [{name: "Dedicated time during team meetings", default: true, current: false}, {name: "Open office hours", default: false, current: false}, {name: "Individual check-ins", default: false, current: false}, {name: "Set up specific channels using your organization's virtual chat platform", default: false, current: false}]                        }
    ...
    {
        title: "Give Memorable Positive Feedback",
        image: "/feedback.jpg",
...
items: [{name: "Dedicated time during team meetings", default: true, current: false}, {name: "Open office hours", default: false, current: false}, {name: "Individual check-ins", default: false, current: false}, {name: "Set up specific channels using your organization's virtual chat platform", default: false, current: false}]                        }
        ...
        slides: [
            {
                title: "Overview",
                shortTitle: "Overview",
                whatYouGet: "A major driver of your team's engagement is when members feel their contributions are " +
                    "recognized and valued. This guide helps you give positive feedback that resonates.",
                htmlElements: [
                    {
                        typeOfElement: "header",
                        content: "What does this training tool help you do?"
    ...
    {
        title: "Conduct a Meaningful Virtual One-on-One",
        ...
        slides: [
            {
                title: "Overview",
                shortTitle: "Overview",
                whatYouGet: "Virtual workflows have a tendency to create knowledge and communication gaps. Use this guide " +
                    "to set up conversations addressing critical needs that get lost in virtual settings.",
                htmlElements: [
                    {
                        typeOfElement: "header",
                        content: "What does this training tool help you do?"
...
items: [{name: "Dedicated time during team meetings", default: true, current: false}, {name: "Open office hours", default: false, current: false}, {name: "Individual check-ins", default: false, current: false}, {name: "Set up specific channels using your organization's virtual chat platform", default: false, current: false}]                        }
        ...
        slides: [
            {
                title: "Overview",
                shortTitle: "Overview",
                whatYouGet: "Saying \"no\" to your boss' request when it is warranted is a delicate, but important " +
                    "skill to have. Plan how to decline a request without coming off as incompetent or insubordinate.",
                htmlElements: [
                    {
                        typeOfElement: "header",
                        content: "What does this training tool help you do?"
    ...
    {
        title: "Make Progress on Your Strategic Priorities in the Next Two Weeks",
        image: "/meeting.jpg",
...
items: [{name: "Dedicated time during team meetings", default: true, current: false}, {name: "Open office hours", default: false, current: false}, {name: "Individual check-ins", default: false, current: false}, {name: "Set up specific channels using your organization's virtual chat platform", default: false, current: false}]                        }
        ...
        slides: [
            {
                title: "Overview",
                shortTitle: "Overview",
                whatYouGet: "It's easy for strategic progress to get lost in day-to-day business. Use this tool to set " +
                    "and reach attainable milestones towards strategic priorities.",
                htmlElements: [
                    {
                        typeOfElement: "header",
                        content: "What does this training tool help you do?"
    ...
    {
        title: "Say \"No\" to Your Staff While Showing Support",
        image: "/feedback.jpg",
...
items: [{name: "Dedicated time during team meetings", default: true, current: false}, {name: "Open office hours", default: false, current: false}, {name: "Individual check-ins", default: false, current: false}, {name: "Set up specific channels using your organization's virtual chat platform", default: false, current: false}]                        }
    ...
    {
        title: "Improving Staff Engagement with a New Management Habit",
        image: "/digitalmeeting.jpg",
        ...
        slides: [
            {
                title: "Overview",
                shortTitle: "Overview",
                whatYouGet: "It can be difficult to build engagement among staff, especially if they are already disengaged. " +
                    "Follow these steps to implement a small habit of your own that grows engagement over time.",
                htmlElements: [
                    {
                        typeOfElement: "header",
                        content: "What does this training tool help you do?"
